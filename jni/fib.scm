...
#;
(define android-print
  (c-lambda (char-string) char-string "input_from_scheme"))
(define android-print (lambda (char) (void)))
...
(define (main)
  ...
  (repl-server-start #f intercept-output: (lambda (char) (android-print char)))
  ;(thread-sleep! +inf.0)
  )
