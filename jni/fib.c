...
; File: "fib.c", produced by Gambit-C v4.7.1
(
407001
" fib"
((" fib"))
...
___NEED_GLO(___G_c_2d_testports)
___NEED_GLO(___G_fib)
___NEED_GLO(___G_open_2d_process)
___NEED_GLO(___G_read_2d_line)
___NEED_GLO(___G_test_2d_ports)

___BEGIN_SYM
___DEF_SYM(0,___S_fib,"fib")
___END_SYM

#define ___SYM_fib ___SYM(0,___S_fib)

___BEGIN_GLO
___DEF_GLO(0," fib")
___DEF_GLO(1,"c-fib")
___DEF_GLO(2,"c-testports")
___DEF_GLO(3,"fib")
___DEF_GLO(4,"test-ports")
___DEF_GLO(5,"+")
___DEF_GLO(6,"-")
___DEF_GLO(7,"=")
___DEF_GLO(8,"open-process")
___DEF_GLO(9,"read-line")
___END_GLO

#define ___GLO__20_fib ___GLO(0,___G__20_fib)
#define ___PRM__20_fib ___PRM(0,___G__20_fib)
#define ___GLO_c_2d_fib ___GLO(1,___G_c_2d_fib)
#define ___PRM_c_2d_fib ___PRM(1,___G_c_2d_fib)
#define ___GLO_c_2d_testports ___GLO(2,___G_c_2d_testports)
#define ___PRM_c_2d_testports ___PRM(2,___G_c_2d_testports)
#define ___GLO_fib ___GLO(3,___G_fib)
#define ___PRM_fib ___PRM(3,___G_fib)
#define ___GLO_test_2d_ports ___GLO(4,___G_test_2d_ports)
#define ___PRM_test_2d_ports ___PRM(4,___G_test_2d_ports)
#define ___GLO__2b_ ___GLO(5,___G__2b_)
#define ___PRM__2b_ ___PRM(5,___G__2b_)
#define ___GLO__2d_ ___GLO(6,___G__2d_)
#define ___PRM__2d_ ___PRM(6,___G__2d_)
#define ___GLO__3d_ ___GLO(7,___G__3d_)
#define ___PRM__3d_ ___PRM(7,___G__3d_)
#define ___GLO_open_2d_process ___GLO(8,___G_open_2d_process)
#define ___PRM_open_2d_process ___PRM(8,___G_open_2d_process)
#define ___GLO_read_2d_line ___GLO(9,___G_read_2d_line)
#define ___PRM_read_2d_line ___PRM(9,___G_read_2d_line)

___DEF_SUB_STR(___X0,2)
               ___STR2(108,115)
___DEF_SUB_STR(___X1,6)
               ___STR6(102,97,105,108,101,100)
___DEF_SUB_VEC(___X2,5)
               ___VEC1(___REF_SYM(0,___S_fib))
...
#define ___C_LBL_fib 38
#define ___C_LBL_testports 41
...
#undef ___NARGS
 ...
 char* testports ___PVOID
{
#define ___NARGS 0
___BEGIN_SFUN(___MLBL(___C_LBL_testports),char* ___result)
___BEGIN_SFUN_BODY
___SFUN_CALL
...
___DEF_M_HLBL_INTRO
___DEF_M_HLBL(___L0_test_2d_ports)
___DEF_M_HLBL(___L1_test_2d_ports)
___DEF_M_HLBL(___L2_test_2d_ports)
___DEF_M_HLBL(___L3_test_2d_ports)
___DEF_M_HLBL_INTRO
___DEF_M_HLBL(___L0_c_2d_fib)
___DEF_M_HLBL(___L1_c_2d_fib)
___DEF_M_HLBL_INTRO
___DEF_M_HLBL(___L0_c_2d_testports)
___DEF_M_HLBL(___L1_c_2d_testports)
___END_M_HLBL
...
___DEF_GLBL(___L__20_fib)
   ___SET_GLO(3,___G_fib,___PRC(3))
   ___SET_GLO(4,___G_test_2d_ports,___PRC(33))
   ___SET_GLO(1,___G_c_2d_fib,___PRC(38))
   ___SET_GLO(2,___G_c_2d_testports,___PRC(41))
   ___SET_R1(___VOID)
...
___DEF_GLBL(___L37_fib)
   ___JUMPGLOSAFE(___SET_NARGS(2),6,___G__2d_)
...
___DEF_SLBL(9,___L9_fib)
   ___JUMPGLOSAFE(___SET_NARGS(2),5,___G__2b_)
...
___DEF_GLBL(___L62_fib)
   ___JUMPGLOSAFE(___SET_NARGS(2),7,___G__3d_)
...
#undef ___PH_PROC
#define ___PH_PROC ___H_test_2d_ports
#undef ___PH_LBL0
...
___BEGIN_P_HLBL
___DEF_P_HLBL_INTRO
___DEF_P_HLBL(___L0_test_2d_ports)
___DEF_P_HLBL(___L1_test_2d_ports)
___DEF_P_HLBL(___L2_test_2d_ports)
___DEF_P_HLBL(___L3_test_2d_ports)
___END_P_HLBL
___BEGIN_P_SW
___DEF_SLBL(0,___L0_test_2d_ports)
   ___IF_NARGS_EQ(0,___NOTHING)
   ___WRONG_NARGS(0,0,0,0)
___DEF_GLBL(___L_test_2d_ports)
   ___SET_STK(1,___R0)
   ___SET_R1(___SUB(0))
   ___SET_R0(___LBL(2))
   ___ADJFP(4)
   ___POLL(1)
___DEF_SLBL(1,___L1_test_2d_ports)
   ___JUMPGLOSAFE(___SET_NARGS(1),8,___G_open_2d_process)
___DEF_SLBL(2,___L2_test_2d_ports)
   ___SET_R2(___SUB(1))
   ___SET_R0(___STK(-3))
   ___POLL(3)
___DEF_SLBL(3,___L3_test_2d_ports)
   ___ADJFP(-4)
   ___JUMPGLOSAFE(___SET_NARGS(2),9,___G_read_2d_line)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_c_2d_fib)
   ___JUMPGLOSAFE(___SET_NARGS(1),3,___G_fib)
___END_P_SW
___END_P_COD

#undef ___PH_PROC
#define ___PH_PROC ___H_c_2d_testports
#undef ___PH_LBL0
...
___BEGIN_P_HLBL
___DEF_P_HLBL_INTRO
___DEF_P_HLBL(___L0_c_2d_testports)
___DEF_P_HLBL(___L1_c_2d_testports)
___END_P_HLBL
___BEGIN_P_SW
___DEF_SLBL(0,___L0_c_2d_testports)
   ___IF_NARGS_EQ(0,___NOTHING)
   ___WRONG_NARGS(0,0,0,0)
___DEF_GLBL(___L_c_2d_testports)
   ___POLL(1)
___DEF_SLBL(1,___L1_c_2d_testports)
   ___JUMPGLOSAFE(___SET_NARGS(0),4,___G_test_2d_ports)
___END_P_SW
___END_P_COD
...
,___DEF_LBL_PROC(___H__20_fib,0,-1)
,___DEF_LBL_INTRO(___H_fib,0,___REF_FAL,29,0)
,___DEF_LBL_PROC(___H_fib,1,-1)
...
,___DEF_LBL_INTRO(___H_test_2d_ports,0,___REF_FAL,4,0)
,___DEF_LBL_PROC(___H_test_2d_ports,0,-1)
,___DEF_LBL_RET(___H_test_2d_ports,___IFD(___RETI,4,0,0x3f1L))
,___DEF_LBL_RET(___H_test_2d_ports,___IFD(___RETN,1,0,0x1L))
,___DEF_LBL_RET(___H_test_2d_ports,___IFD(___RETI,4,4,0x3f0L))
,___DEF_LBL_INTRO(___H_c_2d_fib,0,___REF_FAL,2,fib)
,___DEF_LBL_PROC(___H_c_2d_fib,1,-1)
,___DEF_LBL_RET(___H_c_2d_fib,___IFD(___RETI,0,0,0x3fL))
,___DEF_LBL_INTRO(___H_c_2d_testports,0,___REF_FAL,2,testports)
,___DEF_LBL_PROC(___H_c_2d_testports,0,-1)
,___DEF_LBL_RET(___H_c_2d_testports,___IFD(___RETI,0,0,0x3fL))
___END_LBL

___BEGIN_MOD_PRM
___DEF_MOD_PRM(0,___G__20_fib,1)
___END_MOD_PRM
...
___BEGIN_MOD_GLO
___DEF_MOD_GLO(0,___G__20_fib,1)
___END_MOD_GLO

___BEGIN_MOD_SYM_KEY
___DEF_MOD_SYM(0,___S_fib,"fib")
___END_MOD_SYM_KEY
